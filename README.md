...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/bumpver-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12377&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/bumpver-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `bumpver` can be installed with:

```
conda install bumpver
```

It is possible to list all of the versions of `bumpver` available on your platform with:
